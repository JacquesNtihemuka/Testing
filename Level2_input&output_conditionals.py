...
favorite_liquid = input("What is your favorite liquid?")
...
boiling_point = 100.0
freezing_point= 0
# TODO 9: Calculate the temperature range ()
...
print(f"\nAnalyzing {favorite_liquid} at {temperature}°C...")
...
print("\nTesting Part 5...")
try:
    print(f"\nRESULT: At {temperature}°C, {favorite_liquid} is in the {state} state!")
